    ...
    <div className="auth-shell">
      <main className="auth-content">
        ...
        <div className="auth-card" style={{ width: 'calc(100vw - 40px)', maxWidth: '470px', boxSizing: 'border-box' }}>
          <span className="text-xs font-semibold uppercase tracking-[0.16em] text-blue-600 dark:text-blue-400">{eyebrow}</span>
          ...
          {footer && <div className="mt-7 border-t border-slate-100 pt-6 text-center text-sm text-slate-500 dark:border-slate-800 dark:text-slate-400">{footer}</div>}
        </div>
